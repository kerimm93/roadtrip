...
* Dedupe is preview-only: no merge, archive, delete, status change, pool promotion or hidden apply action.
* Main-chat cleanup decisions use `roadtrip-mainchat-decisions-v1`.
* Dedupe decisions use `roadtrip-dedupe-decisions-v1`.
...
* not a Dedupe apply path and not a status/pool/promotion/create/archive/delete path
