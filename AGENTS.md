...
- **Versionierte Dedupe-Rückgabe ist Preview-only:** Für
  `roadtrip-dedupe-decisions-v1` gibt es keinen Apply-, Merge-, Archivierungs-,
  Lösch-, Status-, Pool- oder Duplicate-Markierungs-Pfad. Der separate direkte
  Cleanup-Review-Papierkorbpfad für konkret identifizierte Dubletten bleibt ein
  bestehender, bestätigungspflichtiger Sonderpfad und ist kein strukturierter
  Dedupe-Apply-Vertrag.
