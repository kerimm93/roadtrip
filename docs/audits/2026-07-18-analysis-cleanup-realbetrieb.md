...
- Dedupe blieb vollständig mutationsfrei.
- Es gab keine Merge-, Archivierungs-, Lösch-, Status-, Pool- oder sonstige
  Dedupe-Mutation.
...
Paartext belegt waren. Die lokale Preview verhinderte eine Mutation. Dedupe bleibt
Preview-only; ein späterer Dedupe-Apply braucht einen eigenen atomaren Vertrag und
gehört nicht in die nächste Workbench-Arbeit.
