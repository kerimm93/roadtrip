...
(function(){
  S = defaultState();
  save = function(){}; renderView = function(){};
  ...
  const run = createCleanupWorkbenchRunFromReview({ summary: 's' }, proposals, ['Frage']);
  ...
  live2.reviewState.cases[ids[0]].status = 'reviewed'; live2.reviewState.cases[ids[0]].updatedAt = '2026-07-21T00:00:00.000Z'; live2.reviewState.runStatus = 'completed'; live2.completedAt = 'done'; upsertCleanupWorkbenchRun(live2); hydrateCleanupReviewFromWorkbenchRun(live2); reopenCleanupWorkbenchRun();
